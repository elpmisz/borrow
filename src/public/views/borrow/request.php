      ...
      <div class="card shadow">
        ...
        <div class="card-body">
          <form action="/borrow/add" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
            ...
            <div class="row mb-2">
              <label class="col-xl-4 col-md-4 col-form-label text-xl-end">วันที่ ยืม - คืน</label>
            ...
            <div class="row mb-2">
              <label class="col-xl-4 col-md-4 col-form-label text-xl-end">จุดประสงค์การยืม</label>
              <div class="col-xl-6 col-md-8">
                  ...
                  <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                      <tr class="tr_add">
                        ...
                        <td>
                          <select class="form-select form-select-sm item" name="item_id[]" data-placeholder="-- เลือก --" required></select>
                          <div class="invalid-feedback">
                            กรุณาเลือกช่องนี้.
                          </div>
                        </td>
