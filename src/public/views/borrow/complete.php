  ...
  <div class="row justify-content-center">
    ...
    <div class="col-xl-12">
      <div class="card shadow">
        ...
        <div class="card-body">
          <form action="/borrow/complete" method="POST" class="needs-validation" enctype="multipart/form-data"
            novalidate>
            ...
            <div class="row mb-2">
              ...
              <div class="col-xl-4 col-md-4 ">
                <input type="text" class="form-control form-control-sm date" value="<?php echo $row['date'] ?>"
                  readonly>
              </div>
            </div>
            <div class="row mb-2">
            ...
            <div class="row mb-2">
              ...
              <div class="col-xl-6 col-md-8 ">
                <input type="text" class="form-control form-control-sm"
                  value="<?php echo $row['approver_name'] . " " . $row['approve_datetime'] ?>" readonly>
              </div>
            </div>
            ...
            <div class="row mb-2 div_text">
              ...
              <div class="col-xl-6 col-md-8">
                <textarea class="form-control form-control-sm" rows="3"
                  readonly><?php echo $row['approve_text'] ?></textarea>
              </div>
            </div>
