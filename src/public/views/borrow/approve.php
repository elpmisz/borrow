                        ...
                        <?php foreach ($items as $key => $item) : $key++; ?>
                          <tr>
                            ...
                            <td class="text-center">
                              <?php echo $Borrows->count_item([$item['user_id'], $user['zone_id'], $item['item_id']]) ?>
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-center">
                              ...
                              <input type="number" class="form-control form-control-sm text-center amount" name="item__confirm[]" value="<?php echo $item['confirm'] ?>" min="1">
                            </td>
