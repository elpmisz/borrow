                        ...
                        ?>
                          <tr>
                            ...
                            <td class="text-center">
                              ...
                              <input type="number" class="form-control form-control-sm text-center amount" name="item__confirm[]" value="<?php echo $item['request_amount'] ?>" min="1" max="<?php echo $item['stock'] ?>">
                            </td>
