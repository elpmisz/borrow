  ...
  <div class="row justify-content-center">
    ...
    <div class="col-xl-12">
      <div class="card shadow">
        ...
        <div class="card-body">
          <form action="/borrow/approve" method="POST" class="needs-validation" enctype="multipart/form-data"
            novalidate>
            ...
            <div class="row mb-2">
              ...
              <div class="col-xl-4 col-md-4 ">
                <input type="text" class="form-control form-control-sm" value="<?php echo $row['date_borrow'] ?>"
                  readonly>
              </div>
            </div>
            <?php endif; ?>
            ...
            <div class="row mb-2 div_return">
              ...
              <div class="col-xl-4 col-md-4 ">
                <input type="text" class="form-control form-control-sm" value="<?php echo $row['date_return'] ?>"
                  readonly>
              </div>
            </div>
            <?php endif; ?>
            ...
            <div class="row mb-2">
              <label
                class="col-xl-4 col-md-4 col-form-label text-xl-end"><?php echo ($row['type_id'] === 1 ? "จุดประสงค์การยืม" : "รายละเอียดเพิ่มเติม") ?></label>
              <div class="col-xl-6 col-md-8">
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <input type="hidden" class="form-control form-control-sm text-center" name="item__id[]"
                            value="<?php echo $item['request_id'] ?>" readonly>
                          <input type="number" class="form-control form-control-sm text-center amount"
                            name="item__confirm[]" value="<?php echo $item['request_amount'] ?>" min="1"
                            max="<?php echo $stock ?>">
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <input type="number" class="form-control form-control-sm text-center" name="borrow_amount[]"
                            value="<?php echo $item['item_return'] ?>"
                            <?php echo ($row['type_id'] === 2 ? 'min="1"' : "")  ?>
                            max="<?php echo $item['balance'] ?>">
                        </td>
                        <td class="text-center"><?php echo $item['item_unit'] ?></td>
                      </tr>
                      <?php endforeach; ?>
...
?>
<?php if ($row['type_id'] === 1 && $count_location > 0) : ?>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAaCQJfnRNiel1cPN93BlAzFP3uQset6hs&callback=initMap" async
  defer></script>
<script>
function initMap() {
